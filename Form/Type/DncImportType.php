 ...
 * Class DncImportType.
 */
class DncImportType extends AbstractType
{
    /**
        ...
        $builder->add(
            ...
            [
                'attr' => [
                    ...
                    'icon'    => 'fa fa-upload',
                    'onclick' => "mQuery(this).prop('disabled', true); mQuery('form[name=\'dnc_import\']').submit();",
                ],
                'label' => 'mautic.dnc.import.upload',
            ]
        );
