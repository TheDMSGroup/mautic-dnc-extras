...
namespace MauticPlugin\MauticDoNotContactExtrasBundle\Command;
...
/**
 * CLI Command to import custom DNC data.
 */
class ImportCommand extends ContainerAwareCommand
{
    ...
    {
        $this->setName('mautic:dnc:import')
            ->setDescription('Imports custom dnc data to Mautic')
...
EOT
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        /** @var \MauticPlugin\MauticDoNotContactExtrasBundle\Model\DncImportModel $model */
        $model = $this->getContainer()->get('mautic.donotcontactextras.model.dncimport');
