 ...
 */
if ('index' == $tmpl):
    $view->extend('MauticDoNotContactExtrasBundle:Import:index.html.php');
endif;
?>
...
<div class="table-responsive">
    <table class="table table-hover table-striped table-bordered" id="importTable">
        <thead>
            <tr>
                ...
                echo $view->render('MauticCoreBundle:Helper:tableheader.html.php', [
                    ...
                    'text'       => 'mautic.dnc.import.source.file',
                    'class'      => 'col-original-file',
                ]);

                echo $view->render('MauticCoreBundle:Helper:tableheader.html.php', [
                    'text'  => 'mautic.dnc.import.runtime',
                    'class' => 'col-runtime',
                ]);

                echo $view->render('MauticCoreBundle:Helper:tableheader.html.php', [
                    'text'  => 'mautic.dnc.import.progress',
                    'class' => 'col-progress',
                ]);
                ...
                echo $view->render('MauticCoreBundle:Helper:tableheader.html.php', [
                    ...
                    'text'       => 'mautic.dnc.import.line.count',
                ...
                echo $view->render('MauticCoreBundle:Helper:tableheader.html.php', [
                    ...
                    'text'       => 'mautic.dnc.import.inserted.count',
                ...
                echo $view->render('MauticCoreBundle:Helper:tableheader.html.php', [
                    ...
                    'text'       => 'mautic.dnc.import.updated.count',
                ...
                echo $view->render('MauticCoreBundle:Helper:tableheader.html.php', [
                    ...
                    'text'       => 'mautic.dnc.import.ignored.count',
        ...
        <tbody>
        <?php echo $view->render('MauticDoNotContactExtrasBundle:Import:list_rows.html.php', [
            'items'           => $items,
...
<div class="panel-footer">
    <?php echo $view->render('MauticCoreBundle:Helper:pagination.html.php', [
        ...
        'baseUrl'    => $view['router']->path($indexRoute, ['object' => 'dnc']),
        'sessionVar' => $sessionVar,
    ]); ?>
</div>
<?php else: ?>
