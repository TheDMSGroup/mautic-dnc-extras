...
$view['slots']->set('headerTitle', $view['translator']->trans('mautic.dnc.import.dnci', ['%object%' => $object]));
    ...
    <div class="col-sm-offset-3 col-sm-6 text-center">
        <div class="panel panel-<?php echo ($complete) ? 'success' : 'danger'; ?>">
            ...
            <div class="panel-body">
                <?php if (!$complete): ?>
                    <h4><?php echo $view['translator']->trans('mautic.dnc.import.inprogress'); ?></h4>
                <?php else: ?>
                    <h4>
                        <?php echo $view['translator']->trans(
                            'mautic.dnc.import.stats',
                            [
